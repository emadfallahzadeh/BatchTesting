...
if main_batch_size == 0:
    algorithm_type = 'batchall' + '_' + str(cpu_count) + 'cpu'
else:
...
def process_batch(running_builds, fail_tests, batch, run_order, run_time, cpu_count, cpu_time):
    for build in running_builds:
    ...
    return fail_tests, run_order, run_time, batch, cpu_time
...
while build_counter < len(builds):
    ...
    fail_tests, run_order, run_time, batch, cpu_time = process_batch(running_builds, fail_tests, batch, run_order, run_time, cpu_count, cpu_time)
