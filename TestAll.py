...
def process_builds(running_builds, cpu_count, run_order, run_time, cpu_time):
    running_tests = get_running_tests(running_builds)
    for test in running_tests:
        run_order += 1
        run_time += test['execution_time'] / cpu_count
        cpu_time += test['execution_time'] / cpu_count
...
for l in range(0, build_count):
    ...
    run_order, run_time, cpu_time = process_builds([running_build], cpu_count, run_order, run_time, cpu_time)
